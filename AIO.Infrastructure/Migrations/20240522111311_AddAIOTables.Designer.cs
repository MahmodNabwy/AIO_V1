...
namespace AIO.Infrastructure.Migrations
{
    ...
    [Migration("20240522111311_AddAIOTables")]
    partial class AddAIOTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AIO.Core.Entities.Insurance_conditions.Insurance_Condition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AIO.Core.Entities.PaymentMethods.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AIO.Core.Entities.ProjectInsurances.ProjectInsurance", b =>
                {
                    ...
                    b.Property<int>("InsuranceConditionId")
                        .HasColumnType("int")
                        .HasColumnName("insurance_condition_id");
                    ...
                    b.HasIndex("InsuranceConditionId");
            ...
            modelBuilder.Entity("AIO.Core.Entities.Projects.Project", b =>
                {
                    ...
                    b.Property<DateTime>("assigned_to_date")
                        .HasColumnType("datetime2")
            ...
            modelBuilder.Entity("AIO.Core.Entities.SupplierPaymentMethods.SupplierPaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("supplier_payment_method");
                });
            ...
            modelBuilder.Entity("AIO.Core.Entities.ProjectInsurances.ProjectInsurance", b =>
                {
                    b.HasOne("AIO.Core.Entities.Insurance_conditions.Insurance_Condition", "InsuranceCondition")
                        .WithMany("ProjectInsurances")
                        .HasForeignKey("InsuranceConditionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("InsuranceCondition");
            ...
            modelBuilder.Entity("AIO.Core.Entities.ProjectPaymentMethods.ProjectPaymentMethod", b =>
                {
                    b.HasOne("AIO.Core.Entities.PaymentMethods.PaymentMethod", "PaymentMethod")
