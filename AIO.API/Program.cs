using AIO.API.Middlewares;
using AIO.API.ServiceBuilderExtensions;
using AIO.API;
...
using AIO.Application;
using AutoMapper;
using Microsoft.AspNetCore.Hosting.Server;
using AIO.Core.IServices.Custom;
using AIO.Application.Helpers;
...
{
    cfg.AddProfile(new AIO.Application.Helpers.MappingProfile(provider.GetService<IServer>(), provider.GetService<IUnitOfWork>()));
}).CreateMapper());
